...
public class NotificationCompat {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                for (int i = this.mMessages.size() - 1; i >= 0; i--) {
                    ...
                    if (i != this.mMessages.size() - 1) {
                        completeMessage.insert(0, (CharSequence) Common.CRLF);
                    }
    ...
    public static class Action {
        ...
        Action(int icon2, CharSequence title2, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
            this(icon2 == 0 ? null : IconCompat.createWithResource(null, "", icon2), title2, intent, extras, remoteInputs, dataOnlyRemoteInputs, allowGeneratedReplies, semanticAction, showsUserInterface, isContextual);
        }

        Action(@Nullable IconCompat icon2, CharSequence title2, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
        ...
        public static final class Builder {
            ...
            private Builder(@Nullable IconCompat icon, CharSequence title, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
    ...
    public static final class BubbleMetadata {
        ...
        private BubbleMetadata(PendingIntent expandIntent, PendingIntent deleteIntent, IconCompat icon, int height, @DimenRes int heightResId, int flags) {
