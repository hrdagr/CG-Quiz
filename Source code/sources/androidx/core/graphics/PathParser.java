...
public class PathParser {
    ...
    private static float[] getFloats(String s) {
        ...
        try {
            ...
            throw new RuntimeException("error in parsing \"" + s + Common.QUOTE, e);
        }
    }
    ...
    private static void extract(String s, int start, ExtractFloatResult result) {
        ...
        for (int currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case KeyCodes.KEYCODE_MINUS /*{ENCODED_INT: 69}*/:
                case 'e':
                    isExponential = true;
                    break;
            }
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case KeyCodes.KEYCODE_ENVELOPE /*{ENCODED_INT: 65}*/:
                case 'a':
                    incr = 7;
                    break;
                case KeyCodes.KEYCODE_DEL /*{ENCODED_INT: 67}*/:
                case 'c':
                    incr = 6;
                    break;
                case KeyCodes.KEYCODE_RIGHT_BRACKET /*{ENCODED_INT: 72}*/:
                case KeyCodes.KEYCODE_MEDIA_STOP /*{ENCODED_INT: 86}*/:
                case 'h':
                case 'v':
                    incr = 1;
                    break;
                case KeyCodes.KEYCODE_SLASH /*{ENCODED_INT: 76}*/:
                case KeyCodes.KEYCODE_AT /*{ENCODED_INT: 77}*/:
                case KeyCodes.KEYCODE_SEARCH /*{ENCODED_INT: 84}*/:
                case 'l':
                case 'm':
                case 't':
                    incr = 2;
                    break;
                case KeyCodes.KEYCODE_PLUS /*{ENCODED_INT: 81}*/:
                case KeyCodes.KEYCODE_NOTIFICATION /*{ENCODED_INT: 83}*/:
                case 'q':
                case 's':
                    incr = 4;
                    break;
                case KeyCodes.KEYCODE_MEDIA_FAST_FORWARD /*{ENCODED_INT: 90}*/:
                case 'z':
                    path.close();
