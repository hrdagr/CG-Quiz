...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SCROLL_LEFT = new AccessibilityActionCompat(accessibilityAction3, 16908345, null, null, null);
            if (Build.VERSION.SDK_INT >= 23) {
                accessibilityAction4 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_DOWN;
            } else {
                accessibilityAction4 = null;
            }
            ACTION_SCROLL_DOWN = new AccessibilityActionCompat(accessibilityAction4, 16908346, null, null, null);
            if (Build.VERSION.SDK_INT >= 23) {
                accessibilityAction5 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_RIGHT;
            } else {
                accessibilityAction5 = null;
            }
            ACTION_SCROLL_RIGHT = new AccessibilityActionCompat(accessibilityAction5, 16908347, null, null, null);
            if (Build.VERSION.SDK_INT >= 29) {
                accessibilityAction6 = AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_UP;
            } else {
                accessibilityAction6 = null;
            }
            ACTION_PAGE_UP = new AccessibilityActionCompat(accessibilityAction6, 16908358, null, null, null);
            if (Build.VERSION.SDK_INT >= 29) {
                accessibilityAction7 = AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_DOWN;
            } else {
                accessibilityAction7 = null;
            }
            ACTION_PAGE_DOWN = new AccessibilityActionCompat(accessibilityAction7, 16908359, null, null, null);
            if (Build.VERSION.SDK_INT >= 29) {
                accessibilityAction8 = AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_LEFT;
            } else {
                accessibilityAction8 = null;
            }
            ACTION_PAGE_LEFT = new AccessibilityActionCompat(accessibilityAction8, 16908360, null, null, null);
            if (Build.VERSION.SDK_INT >= 29) {
                accessibilityAction9 = AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_RIGHT;
            } else {
                accessibilityAction9 = null;
            }
            ACTION_PAGE_RIGHT = new AccessibilityActionCompat(accessibilityAction9, 16908361, null, null, null);
            if (Build.VERSION.SDK_INT >= 23) {
                accessibilityAction10 = AccessibilityNodeInfo.AccessibilityAction.ACTION_CONTEXT_CLICK;
            } else {
                accessibilityAction10 = null;
            }
            ACTION_CONTEXT_CLICK = new AccessibilityActionCompat(accessibilityAction10, 16908348, null, null, null);
            if (Build.VERSION.SDK_INT >= 28) {
                accessibilityAction11 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_TOOLTIP;
            } else {
                accessibilityAction11 = null;
            }
            ACTION_SHOW_TOOLTIP = new AccessibilityActionCompat(accessibilityAction11, 16908356, null, null, null);
            if (Build.VERSION.SDK_INT >= 28) {
                accessibilityAction12 = AccessibilityNodeInfo.AccessibilityAction.ACTION_HIDE_TOOLTIP;
            } else {
                accessibilityAction12 = null;
            }
            ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(accessibilityAction12, 16908357, null, null, null);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mVirtualDescendantId != other.mVirtualDescendantId) {
            return false;
        }
        return this.mParentVirtualDescendantId == other.mParentVirtualDescendantId;
    }
